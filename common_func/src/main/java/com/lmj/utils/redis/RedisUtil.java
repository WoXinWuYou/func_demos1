 ...
 * @Package: com.ldst.classifyserver.utils.redisutil
 * @ClassName: RedisUtil
 * @Author: 孙培柱
...
public class RedisUtil {
    ...
    /**
     * @param
     * @Method initRedisTemplate 初始化Redis序列
     * @Params:
     * @Return void
     * @Exception
     * @Author 孙培柱
    ...
    public static boolean set(String key, Object value) {
        try {
            ...
            LogUtils.error("redis.set:"+ExceptionUtils.getStackTraceAsString(e));
            return false;
        }
    ...
    public static Set zrangeWithThrowable(String key,double begin,double end){
