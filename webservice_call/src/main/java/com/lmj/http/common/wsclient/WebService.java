 ...
 * 
 */
//@WebServiceClient(name = "WebService", targetNamespace = "", wsdlLocation = "http://172.18.80.20:8156/WebService.asmx?wsdl")
// @WebServiceClient(name = "WebService", targetNamespace = "")
@WebServiceClient(name = "WebService", targetNamespace = "/")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICE_QNAME = new QName("", "WebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://172.18.80.20:8156/WebService.asmx?wsdl");
    ...
    public WebServiceSoap getWebServiceSoap() {
        return super.getPort(new QName("", "WebServiceSoap"), WebServiceSoap.class);
    }
    ...
    public WebServiceSoap getWebServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("", "WebServiceSoap"), WebServiceSoap.class, features);
    }
